...
XTrainCycle<-cbind(A$SC[49:1344],A$CC[49:1344])

XTestCycle<-cbind(A$SC[1393:2256],A$CC[1393:2256])
...
Optimal_C<-c(10,10,1,10,1,10,1)

Optimal_eps<-c(0.001,0.001,0.001,0.01,0,0.0001,0)
...
write.csv(Results,"Model_Indexes1.csv")
write.csv(B,"Model_Errors1.csv")
